...
async def adding_labs():
    ...
    data = {
        ...
        'Диастаз мочи': ['Клиника №1', 'Клиника №2'],
        'Общий анализ мочи': ['Клиника №1', 'Клиника №2'],
        'Гемоглобин': ['Клиника №21', 'Клиника №2', 'Клиника №11'],
        'СОЭ': ['Клиника №1', 'Клиника №2', 'Клиника №21'],
        'Глюкоза': ['Клиника №1', 'Клиника №2', 'Клиника №11'],
        'Кровь с ЭДТА': ['Клиника №21', 'Клиника №2'],
        'Железо': ['Клиника №21', 'Клиника №2', 'Клиника №11'],
        'Сыворотка кол.': ['Клиника №1', 'Клиника №2'],
        'Ферритин': ['Клиника №1', 'Клиника №2', 'Клиника №11'],
        'АЛТ': ['Клиника №1', 'Клиника №21'],
        'АСТ': ['Клиника №1', 'Клиника №2'],
        'Билирубин общий': ['Клиника №21', 'Клиника №2'],
        'Билирубин прямой': ['Клиника №1', 'Клиника №2'],
        'ЛПВП': ['Клиника №21', 'Клиника №2', 'Клиника №11'],
        'ЛПНП': ['Клиника №1', 'Клиника №2'],
        'Холестерин': ['Клиника №1', 'Клиника №21'],
        'Креатинин': ['Клиника №1', 'Клиника №2', 'Клиника №11'],
        'Мочевина': ['Клиника №21', 'Клиника №2', 'Клиника №11'],
        'Триглицериды': ['Клиника №1', 'Клиника №2'],
    }
...
async def adding_special():
    ...
    await Doctor('Артомонова А. А.', spec_for_man).create()
    ...
    await Doctor('Ленина. К. Н.', spec_for_olds).create()
    await Doctor('Обрамова. У. А.', spec_for_olds).create()
